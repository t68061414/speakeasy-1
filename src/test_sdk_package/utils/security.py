...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("TESTSDK2_API_KEY"):
        security_dict["api_key"] = os.getenv("TESTSDK2_API_KEY")

    if os.getenv("TESTSDK2_WORKSPACE_IDENTIFIER"):
        security_dict["workspace_identifier"] = os.getenv(
            "TESTSDK2_WORKSPACE_IDENTIFIER"
        )

    if os.getenv("TESTSDK2_BEARER"):
        security_dict["bearer"] = os.getenv("TESTSDK2_BEARER")
